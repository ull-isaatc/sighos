 ...
 * 
 */
package es.ull.isaatc.simulation.intervalBufferThreaded.factory;
...
public class SimulationFactory implements SimulationObjectFactory {
	...
	public ElementCreator getElementCreatorInstance(int id, TimeFunction elem) throws ClassCastException {
		return new es.ull.isaatc.simulation.intervalBufferThreaded.ElementCreator(simul, elem);
	}
	...
	public ElementCreator getElementCreatorInstance(int id, TimeFunction elem, ElementType et, InitializerFlow flow) throws ClassCastException {
		return new es.ull.isaatc.simulation.intervalBufferThreaded.ElementCreator(simul, elem, 
				(es.ull.isaatc.simulation.intervalBufferThreaded.ElementType)et, 
				(es.ull.isaatc.simulation.intervalBufferThreaded.flow.InitializerFlow)flow);
	}
	...
	public ElementType getElementTypeInstance(int id, String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.intervalBufferThreaded.ElementType(id, simul, description);
	}

	@Override
	public ElementType getElementTypeInstance(int id, String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.intervalBufferThreaded.ElementType(id, simul, description, priority);
	}

	@Override
	public Resource getResourceInstance(int id, String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.intervalBufferThreaded.Resource(id, simul, description);
	}

	@Override
	public ResourceType getResourceTypeInstance(int id, String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.intervalBufferThreaded.ResourceType(id, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(int id,	String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.intervalBufferThreaded.TimeDrivenActivity(id, simul, description);
	}
	...
	public TimeDrivenGenerator getTimeDrivenGeneratorInstance(int id, ElementCreator creator, SimulationCycle cycle) throws ClassCastException {
		return new es.ull.isaatc.simulation.intervalBufferThreaded.TimeDrivenGenerator(simul, (es.ull.isaatc.simulation.intervalBufferThreaded.ElementCreator)creator, cycle);
	}

	@Override
	public WorkGroup getWorkGroupInstance(int id, ResourceType[] rts, int[] needed) throws ClassCastException {
		es.ull.isaatc.simulation.intervalBufferThreaded.ResourceType[] temp = new es.ull.isaatc.simulation.intervalBufferThreaded.ResourceType[rts.length];
		for (int i = 0; i < rts.length; i++)
			temp[i] = (es.ull.isaatc.simulation.intervalBufferThreaded.ResourceType)rts[i];
		return new es.ull.isaatc.simulation.intervalBufferThreaded.WorkGroup(temp, needed);
	}
