...
public class Simulation extends es.ull.isaatc.simulation.common.Simulation {
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.sequential3Phase.Activity} to the model. These method
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.sequential3Phase.ElementType} to the model. These method
	 * is invoked from the object's constructor.
	 * 
	 * @param et
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.sequential3Phase.ResourceType} to the model. These method
	 * is invoked from the object's constructor.
	 * 
	 * @param rt
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.sequential3Phase.flow.Flow} to the model. These method
	 * is invoked from the object's constructor.
	 * 
	 * @param f
