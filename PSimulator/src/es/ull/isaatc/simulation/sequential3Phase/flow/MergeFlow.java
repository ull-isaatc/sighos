...
import es.ull.isaatc.simulation.sequential3Phase.Element;
 ...
 * @author ycallero
 */
public abstract class MergeFlow extends SingleSuccessorFlow implements es.ull.isaatc.simulation.common.flow.MergeFlow, JoinFlow {
	...
	public MergeFlow(Simulation simul, boolean safe) {
		super(simul);
		control = new TreeMap<Element, MergeFlowControl>();
		this.safe = safe;
	}
