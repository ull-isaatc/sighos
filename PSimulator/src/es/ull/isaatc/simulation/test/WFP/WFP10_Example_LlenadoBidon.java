...
class SimulationWFP10E extends StandAloneLPSimulation {
    ...
    protected void createModel() {
    	...
    	new TimeDrivenActivity(0, this, "Rellenar bidon", false);
    	new TimeDrivenActivity(1, this, "Realizar envío de bidon", false);
        ...
        WorkGroup wg1 = factory.getWorkGroupInstance(getResourceType(0), 1);
