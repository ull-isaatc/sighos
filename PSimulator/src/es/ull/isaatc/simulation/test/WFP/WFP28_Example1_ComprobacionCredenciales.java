...
class SimulationWFP28E1 extends StandAloneLPSimulation {
    ...
    protected void createModel() {
    	...
    	new TimeDrivenActivity(0, this, "Confirmar llegada delegacion", false);
    	new TimeDrivenActivity(1, this, "Chequeo de seguridad", false);
    	new TimeDrivenActivity(2, this, "Preparacion para nueva delegacion", false);
