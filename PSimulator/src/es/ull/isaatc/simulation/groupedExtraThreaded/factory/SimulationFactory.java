 ...
 * 
 */
package es.ull.isaatc.simulation.groupedExtraThreaded.factory;
...
public class SimulationFactory implements SimulationObjectFactory {
	 ...
	 * @param endTs
	 */
	public SimulationFactory(int id, String description, boolean pasive, TimeUnit unit,	TimeStamp startTs, TimeStamp endTs) {
		simul = new Simulation(id, description, pasive, unit, startTs, endTs);
	}
	 ...
	 * @param endTs
	 */
	public SimulationFactory(int id, String description, boolean pasive, TimeUnit unit,	long startTs, long endTs) {
		simul = new Simulation(id, description, pasive, unit, startTs, endTs);
	}
	...
	public ElementCreator getElementCreatorInstance(TimeFunction elem) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.ElementCreator(simul, elem);
	}
	...
	public ElementCreator getElementCreatorInstance(TimeFunction elem, ElementType et, InitializerFlow flow) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.ElementCreator(simul, elem, 
				(es.ull.isaatc.simulation.groupedExtraThreaded.ElementType)et, 
				(es.ull.isaatc.simulation.groupedExtraThreaded.flow.InitializerFlow)flow);
	}
	...
	public ElementType getElementTypeInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.ElementType(etId++, simul, description);
	}

	@Override
	public ElementType getElementTypeInstance(String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.ElementType(etId++, simul, description, priority);
	}

	@Override
	public Resource getResourceInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.Resource(resId++, simul, description);
	}

	@Override
	public ResourceType getResourceTypeInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.ResourceType(rtId++, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.TimeDrivenActivity(actId++, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(String description, int priority, EnumSet<Modifier> modifiers) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.TimeDrivenActivity(actId++, simul, description, priority, modifiers);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.FlowDrivenActivity(actId++, simul, description);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.FlowDrivenActivity(actId++, simul, description, priority);
	}
	...
	public TimeDrivenGenerator getTimeDrivenGeneratorInstance(ElementCreator creator, SimulationCycle cycle) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedExtraThreaded.TimeDrivenGenerator(simul, (es.ull.isaatc.simulation.groupedExtraThreaded.ElementCreator)creator, cycle);
	}

	@Override
	public WorkGroup getWorkGroupInstance(ResourceType[] rts, int[] needed) throws ClassCastException {
		es.ull.isaatc.simulation.groupedExtraThreaded.ResourceType[] temp = new es.ull.isaatc.simulation.groupedExtraThreaded.ResourceType[rts.length];
		for (int i = 0; i < rts.length; i++)
			temp[i] = (es.ull.isaatc.simulation.groupedExtraThreaded.ResourceType)rts[i];
		return new es.ull.isaatc.simulation.groupedExtraThreaded.WorkGroup(temp, needed);
	}
