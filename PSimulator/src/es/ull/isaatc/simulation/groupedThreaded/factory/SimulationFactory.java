 ...
 * 
 */
package es.ull.isaatc.simulation.groupedThreaded.factory;
...
public class SimulationFactory implements SimulationObjectFactory {
	...
	public ElementCreator getElementCreatorInstance(TimeFunction elem) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.ElementCreator(simul, elem);
	}
	...
	public ElementCreator getElementCreatorInstance(TimeFunction elem, ElementType et, InitializerFlow flow) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.ElementCreator(simul, elem, 
				(es.ull.isaatc.simulation.groupedThreaded.ElementType)et, 
				(es.ull.isaatc.simulation.groupedThreaded.flow.InitializerFlow)flow);
	}
	...
	public ElementType getElementTypeInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.ElementType(etId++, simul, description);
	}

	@Override
	public ElementType getElementTypeInstance(String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.ElementType(etId++, simul, description, priority);
	}

	@Override
	public Resource getResourceInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.Resource(resId++, simul, description);
	}

	@Override
	public ResourceType getResourceTypeInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.ResourceType(rtId++, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.TimeDrivenActivity(actId++, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(String description, int priority, EnumSet<Modifier> modifiers) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.TimeDrivenActivity(actId++, simul, description, priority, modifiers);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.FlowDrivenActivity(actId++, simul, description);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.FlowDrivenActivity(actId++, simul, description, priority);
	}
	...
	public TimeDrivenGenerator getTimeDrivenGeneratorInstance(ElementCreator creator, SimulationCycle cycle) throws ClassCastException {
		return new es.ull.isaatc.simulation.groupedThreaded.TimeDrivenGenerator(simul, (es.ull.isaatc.simulation.groupedThreaded.ElementCreator)creator, cycle);
	}

	@Override
	public WorkGroup getWorkGroupInstance(ResourceType[] rts, int[] needed) throws ClassCastException {
		es.ull.isaatc.simulation.groupedThreaded.ResourceType[] temp = new es.ull.isaatc.simulation.groupedThreaded.ResourceType[rts.length];
		for (int i = 0; i < rts.length; i++)
			temp[i] = (es.ull.isaatc.simulation.groupedThreaded.ResourceType)rts[i];
		return new es.ull.isaatc.simulation.groupedThreaded.WorkGroup(temp, needed);
	}
