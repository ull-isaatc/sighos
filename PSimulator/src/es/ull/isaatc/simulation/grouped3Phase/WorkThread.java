...
import es.ull.isaatc.simulation.grouped3Phase.flow.BasicFlow;
import es.ull.isaatc.simulation.grouped3Phase.flow.TaskFlow;
import es.ull.isaatc.simulation.grouped3Phase.flow.Flow;
import es.ull.isaatc.simulation.grouped3Phase.flow.SingleFlow;
...
public class WorkThread implements Identifiable, Prioritizable, Comparable<WorkThread> {
	 ...
	 * @param prevFlow The new initial visited flow
