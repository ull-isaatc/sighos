...
public abstract class Activity extends TimeStampedSimulationObject implements es.ull.isaatc.simulation.common.Activity {
     ...
     */
    public int addWorkGroup(int priority, es.ull.isaatc.simulation.intervalThreaded.WorkGroup wg) {
     ...
     * @return The identifier of the new WG.
     */
    public int addWorkGroup(int priority, es.ull.isaatc.simulation.intervalThreaded.WorkGroup wg, Condition cond) {
    	final int wgId = workGroupTable.size();
     ...
     * @return The identifier of the new WG.
     */
    public int addWorkGroup(es.ull.isaatc.simulation.intervalThreaded.WorkGroup wg) {    	
     ...
     * @return The identifier of the new WG.
     */
    public int addWorkGroup(es.ull.isaatc.simulation.intervalThreaded.WorkGroup wg, Condition cond) {    	
	 ...
	 */
	public class ActivityWorkGroup extends es.ull.isaatc.simulation.intervalThreaded.WorkGroup implements es.ull.isaatc.simulation.common.ActivityWorkGroup, Comparable<ActivityWorkGroup> {
	     ...
	     */    
	    protected ActivityWorkGroup(int id, int priority, es.ull.isaatc.simulation.intervalThreaded.WorkGroup wg) {
	     ...
	     * @param cond Availability condition
	     */    
	    protected ActivityWorkGroup(int id, int priority, es.ull.isaatc.simulation.intervalThreaded.WorkGroup wg, Condition cond) {
