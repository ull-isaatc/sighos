...
import es.ull.isaatc.simulation.intervalThreaded.flow.SingleFlow;
import es.ull.isaatc.simulation.intervalThreaded.flow.TaskFlow;
...
public class WorkThread implements Identifiable, Prioritizable, Comparable<WorkThread> {
	...
	private final ArrayList<WorkThread> descendants;
