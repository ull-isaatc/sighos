...
import es.ull.isaatc.simulation.bonnXThreaded.flow.FinalizerFlow;
...
public class FlowDrivenActivity extends Activity implements es.ull.isaatc.simulation.common.FlowDrivenActivity {
	...
	/* (non-Javadoc)
	 * @see es.ull.isaatc.simulation.bonnXThreaded.Activity#carryOut(es.ull.isaatc.simulation.bonnXThreaded.WorkItem)
	 */
	@Override
	public void carryOut(WorkItem wItem) {
		...
		wItem.getWorkThread().getElement().addRequestEvent(initialFlow, wItem.getWorkThread().getInstanceDescendantWorkThread());
	}

	/* (non-Javadoc)
	 * @see es.ull.isaatc.simulation.bonnXThreaded.Activity#finish(es.ull.isaatc.simulation.bonnXThreaded.WorkItem)
	 */
	@Override
...
//		}
	...
	/* (non-Javadoc)
	 * @see es.ull.isaatc.simulation.bonnXThreaded.Activity#request(es.ull.isaatc.simulation.bonnXThreaded.WorkItem)
	 */
	@Override
