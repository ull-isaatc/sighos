 ...
 * 
 */
package es.ull.isaatc.simulation.threaded.factory;
...
public class SimulationFactory implements SimulationObjectFactory {
	 ...
	 * @param endTs
	 */
	public SimulationFactory(int id, String description, boolean javaPool, TimeUnit unit, TimeStamp startTs, TimeStamp endTs) {
		simul = new Simulation(id, description, javaPool, unit, startTs, endTs);
	}
	 ...
	 * @param endTs
	 */
	public SimulationFactory(int id, String description, boolean javaPool, TimeUnit unit, long startTs, long endTs) {
		simul = new Simulation(id, description, javaPool, unit, startTs, endTs);
	}
	...
	public ElementCreator getElementCreatorInstance(TimeFunction elem) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.ElementCreator(simul, elem);
	}
	...
	public ElementCreator getElementCreatorInstance(TimeFunction elem, ElementType et, InitializerFlow flow) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.ElementCreator(simul, elem, 
				(es.ull.isaatc.simulation.threaded.ElementType)et, 
				(es.ull.isaatc.simulation.threaded.flow.InitializerFlow)flow);
	}
	...
	public ElementType getElementTypeInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.ElementType(etId++, simul, description);
	}

	@Override
	public ElementType getElementTypeInstance(String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.ElementType(etId++, simul, description, priority);
	}

	@Override
	public Resource getResourceInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.Resource(resId++, simul, description);
	}

	@Override
	public ResourceType getResourceTypeInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.ResourceType(rtId++, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.TimeDrivenActivity(actId++, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(String description, int priority, EnumSet<Modifier> modifiers) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.TimeDrivenActivity(actId++, simul, description, priority, modifiers);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.FlowDrivenActivity(actId++, simul, description);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.threaded.FlowDrivenActivity(actId++, simul, description, priority);
	}
	...
	public WorkGroup getWorkGroupInstance(ResourceType[] rts, int[] needed) throws ClassCastException {
		es.ull.isaatc.simulation.threaded.ResourceType[] temp = new es.ull.isaatc.simulation.threaded.ResourceType[rts.length];
		for (int i = 0; i < rts.length; i++)
			temp[i] = (es.ull.isaatc.simulation.threaded.ResourceType)rts[i];
		return new es.ull.isaatc.simulation.threaded.WorkGroup(temp, needed);
	}
