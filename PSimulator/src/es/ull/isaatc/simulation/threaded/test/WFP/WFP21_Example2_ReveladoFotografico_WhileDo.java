...
import es.ull.isaatc.simulation.threaded.flow.WhileDoFlow;
    ...
    protected void createModel() {
        ...
        Condition cond = new Condition(this) {
        	...
        	public boolean check(Element e) {
        		return (((es.ull.isaatc.simulation.threaded.Element)e).getVar("fotosReveladas").getValue().intValue() < 10);
        	}
        };
        ...
        SingleFlow sin1 = new SingleFlow(this, (TimeDrivenActivity)getActivity(0)) {
        	...
        	public void afterFinalize(Element e) {
        		((es.ull.isaatc.simulation.threaded.Element)e).putVar("fotosReveladas", ((es.ull.isaatc.simulation.threaded.Element)e).getVar("fotosReveladas").getValue().intValue() + 1);
        		System.out.println("E" + e.getIdentifier() + ": " + ((es.ull.isaatc.simulation.threaded.Element)e).getVar("fotosReveladas") + " fotos reveladas.");
        	}
        };
