...
class SimulationWFP6E1 extends StandAloneLPSimulation {
	...
	public SimulationWFP6E1(int id, int ndays) {
		super(id, "WFP6: Multichoice. EjLamadasEmergencia", TimeUnit.MINUTE, Time.getZero(), new Time(TimeUnit.DAY, ndays));
		this.ndays = ndays;
    }
    ...
    protected void createModel() {
        ...
        ((TimeDrivenActivity)getActivity(3)).addWorkGroup(new ModelTimeFunction(this, "NormalVariate", 15.0, 2.0), wg);
