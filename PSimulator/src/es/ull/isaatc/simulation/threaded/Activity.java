...
public abstract class Activity extends TimeStampedSimulationObject implements es.ull.isaatc.simulation.common.Activity {
     ...
     */
    public int addWorkGroup(int priority, es.ull.isaatc.simulation.threaded.WorkGroup wg) {
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(int priority, es.ull.isaatc.simulation.threaded.WorkGroup wg, Condition cond) {
    	int wgId = workGroupTable.size();
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(es.ull.isaatc.simulation.threaded.WorkGroup wg) {    	
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(es.ull.isaatc.simulation.threaded.WorkGroup wg, Condition cond) {    	
	...
	public class ActivityWorkGroup extends es.ull.isaatc.simulation.threaded.WorkGroup implements es.ull.isaatc.simulation.common.ActivityWorkGroup, Comparable<ActivityWorkGroup> {
	     ...
	     */    
	    protected ActivityWorkGroup(int id, int priority, es.ull.isaatc.simulation.threaded.WorkGroup wg) {
