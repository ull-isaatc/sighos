...
import es.ull.isaatc.simulation.sequential.flow.DiscriminatorFlow;
...
class SimulationWFP28E1 extends StandAloneLPSimulation {
    ...
    protected void createModel() {
        ...
        ((TimeDrivenActivity)getActivity(0)).addWorkGroup(new ModelTimeFunction(this, "NormalVariate", 18.0, 1.0), wg0);
        ((TimeDrivenActivity)getActivity(1)).addWorkGroup(new ModelTimeFunction(this, "NormalVariate", 20.0, 10.0), wg1);
        ((TimeDrivenActivity)getActivity(2)).addWorkGroup(new ModelTimeFunction(this, "NormalVariate", 15.0, 5.0), wg0);
