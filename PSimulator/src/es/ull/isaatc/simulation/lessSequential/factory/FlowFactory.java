...
public class FlowFactory {
	private final static String workingPkg = "es.ull.isaatc.simulation.lessSequential.flow";
	static int id = 0;
	/**
	...
	static public Flow getInstance(int id, String flowType, SimulationUserCode userMethods, Simulation simul, Object... initargs) {
		userMethods.addImports("import es.ull.isaatc.simulation.lessSequential.*;");
