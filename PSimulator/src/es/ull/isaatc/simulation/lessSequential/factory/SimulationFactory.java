 ...
 * 
 */
package es.ull.isaatc.simulation.lessSequential.factory;
...
public class SimulationFactory implements SimulationObjectFactory {
	private final static String workingPkg = "es.ull.isaatc.simulation.lessSequential";
	...
	public ElementCreator getElementCreatorInstance(int id, TimeFunction elem) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.ElementCreator(simul, elem);
	}
	...
	public ElementCreator getElementCreatorInstance(int id, TimeFunction elem, ElementType et, InitializerFlow flow) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.ElementCreator(simul, elem, 
				(es.ull.isaatc.simulation.lessSequential.ElementType)et, 
				(es.ull.isaatc.simulation.lessSequential.flow.InitializerFlow)flow);
	}
	...
	public ElementType getElementTypeInstance(int id, String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.ElementType(id, simul, description);
	}

	@Override
	public ElementType getElementTypeInstance(int id, String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.ElementType(id, simul, description, priority);
	}

	@Override
	public Resource getResourceInstance(int id, String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.Resource(id, simul, description);
	}

	@Override
	public ResourceType getResourceTypeInstance(int id, String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.ResourceType(id, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(int id,	String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.TimeDrivenActivity(id, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(int id,	String description, int priority, EnumSet<Modifier> modifiers) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.TimeDrivenActivity(id, simul, description, priority, modifiers);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(int id, String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.FlowDrivenActivity(id, simul, description);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(int id, String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.FlowDrivenActivity(id, simul, description, priority);
	}
	...
	public TimeDrivenGenerator getTimeDrivenGeneratorInstance(int id, ElementCreator creator, SimulationCycle cycle) throws ClassCastException {
		return new es.ull.isaatc.simulation.lessSequential.TimeDrivenGenerator(simul, (es.ull.isaatc.simulation.lessSequential.ElementCreator)creator, cycle);
	}

	@Override
	public WorkGroup getWorkGroupInstance(int id, ResourceType[] rts, int[] needed) throws ClassCastException {
		es.ull.isaatc.simulation.lessSequential.ResourceType[] temp = new es.ull.isaatc.simulation.lessSequential.ResourceType[rts.length];
		for (int i = 0; i < rts.length; i++)
			temp[i] = (es.ull.isaatc.simulation.lessSequential.ResourceType)rts[i];
		return new es.ull.isaatc.simulation.lessSequential.WorkGroup(temp, needed);
	}
