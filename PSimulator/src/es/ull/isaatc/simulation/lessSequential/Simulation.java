...
import es.ull.isaatc.simulation.lessSequential.flow.Flow;
...
public abstract class Simulation extends es.ull.isaatc.simulation.common.Simulation {
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.lessSequential.Activity} to the model. These method
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.lessSequential.ElementType} to the model. These method
	 * is invoked from the object's constructor.
	 * 
	 * @param et
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.lessSequential.ResourceType} to the model. These method
	 * is invoked from the object's constructor.
	 * 
	 * @param rt
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.lessSequential.flow.Flow} to the model. These method
	 * is invoked from the object's constructor.
	 * 
	 * @param f
