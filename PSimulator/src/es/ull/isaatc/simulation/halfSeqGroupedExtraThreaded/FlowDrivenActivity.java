...
import es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.flow.BasicFlow;
import es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.flow.FinalizerFlow;
import es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.flow.InitializerFlow;
...
public class FlowDrivenActivity extends Activity implements es.ull.isaatc.simulation.common.FlowDrivenActivity {
	...
	/* (non-Javadoc)
	 * @see es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.Activity#carryOut(es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.WorkItem)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.Activity#finish(es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.WorkItem)
	 */
	@Override
...
//		}
	...
	/* (non-Javadoc)
	 * @see es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.Activity#request(es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.WorkItem)
	 */
	@Override
