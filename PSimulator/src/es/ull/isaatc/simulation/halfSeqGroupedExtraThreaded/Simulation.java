...
import es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.flow.Flow;
...
//				assert activityManagerList.get(1).getQueueSize() == 0;
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.Activity} to the model. These method
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.ElementType} to the model. These method
	 * is invoked from the object's constructor.
	 * 
	 * @param et
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.ResourceType} to the model. These method
	 * is invoked from the object's constructor.
	 * 
	 * @param rt
	...
	/**
	 * Adds an {@link es.ull.isaatc.simulation.halfSeqGroupedExtraThreaded.flow.Flow} to the model. These method
	 * is invoked from the object's constructor.
	 * 
	 * @param f
