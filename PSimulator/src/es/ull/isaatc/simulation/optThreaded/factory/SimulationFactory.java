 ...
 * 
 */
package es.ull.isaatc.simulation.optThreaded.factory;
...
public class SimulationFactory implements SimulationObjectFactory {
	private final static String workingPkg = "es.ull.isaatc.simulation.optThreaded";
	...
	public ElementCreator getElementCreatorInstance(TimeFunction elem) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.ElementCreator(simul, elem);
	}
	...
	public ElementCreator getElementCreatorInstance(TimeFunction elem, ElementType et, InitializerFlow flow) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.ElementCreator(simul, elem, 
				(es.ull.isaatc.simulation.optThreaded.ElementType)et, 
				(es.ull.isaatc.simulation.optThreaded.flow.InitializerFlow)flow);
	}
	...
	public ElementType getElementTypeInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.ElementType(etId++, simul, description);
	}

	@Override
	public ElementType getElementTypeInstance(String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.ElementType(etId++, simul, description, priority);
	}

	@Override
	public Resource getResourceInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.Resource(resId++, simul, description);
	}

	@Override
	public ResourceType getResourceTypeInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.ResourceType(rtId++, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.TimeDrivenActivity(actId++, simul, description);
	}
	...
	public TimeDrivenActivity getTimeDrivenActivityInstance(String description, int priority, EnumSet<Modifier> modifiers) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.TimeDrivenActivity(actId++, simul, description, priority, modifiers);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(String description) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.FlowDrivenActivity(actId++, simul, description);
	}

	@Override
	public FlowDrivenActivity getFlowDrivenActivityInstance(String description, int priority) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.FlowDrivenActivity(actId++, simul, description, priority);
	}
	...
	public TimeDrivenGenerator getTimeDrivenGeneratorInstance(ElementCreator creator, SimulationCycle cycle) throws ClassCastException {
		return new es.ull.isaatc.simulation.optThreaded.TimeDrivenGenerator(simul, (es.ull.isaatc.simulation.optThreaded.ElementCreator)creator, cycle);
	}

	@Override
	public WorkGroup getWorkGroupInstance(ResourceType[] rts, int[] needed) throws ClassCastException {
		es.ull.isaatc.simulation.optThreaded.ResourceType[] temp = new es.ull.isaatc.simulation.optThreaded.ResourceType[rts.length];
		for (int i = 0; i < rts.length; i++)
			temp[i] = (es.ull.isaatc.simulation.optThreaded.ResourceType)rts[i];
		return new es.ull.isaatc.simulation.optThreaded.WorkGroup(temp, needed);
	}
