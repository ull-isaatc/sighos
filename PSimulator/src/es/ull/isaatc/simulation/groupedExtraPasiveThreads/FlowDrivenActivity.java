...
import es.ull.isaatc.simulation.groupedExtraPasiveThreads.flow.FinalizerFlow;
import es.ull.isaatc.simulation.common.flow.Flow;
import es.ull.isaatc.simulation.groupedExtraPasiveThreads.flow.InitializerFlow;
import es.ull.isaatc.simulation.common.flow.StructuredFlow;
import es.ull.isaatc.simulation.common.info.ElementActionInfo;
import es.ull.isaatc.simulation.groupedExtraPasiveThreads.flow.BasicFlow;
...
public class FlowDrivenActivity extends Activity implements es.ull.isaatc.simulation.common.FlowDrivenActivity {
	...
	/* (non-Javadoc)
	 * @see es.ull.isaatc.simulation.groupedExtraPasiveThreads.Activity#carryOut(es.ull.isaatc.simulation.groupedExtraPasiveThreads.WorkItem)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see es.ull.isaatc.simulation.groupedExtraPasiveThreads.Activity#finish(es.ull.isaatc.simulation.groupedExtraPasiveThreads.WorkItem)
	 */
	@Override
...
//		}
	...
	/* (non-Javadoc)
	 * @see es.ull.isaatc.simulation.groupedExtraPasiveThreads.Activity#request(es.ull.isaatc.simulation.groupedExtraPasiveThreads.WorkItem)
	 */
	@Override
