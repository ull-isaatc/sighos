 ...
 *         &lt;element name="actQueue" type="{}ComponentRef" maxOccurs="unbounded"/>
...
public class Sampler {
    ...
    @XmlElement(required = true)
    protected List<ComponentRef> actQueue;
     ...
     * This is why there is not a <CODE>set</CODE> method for the actQueue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getActQueue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ComponentRef> getActQueue() {
        if (actQueue == null) {
            actQueue = new ArrayList<ComponentRef>();
        }
        return this.actQueue;
    }
