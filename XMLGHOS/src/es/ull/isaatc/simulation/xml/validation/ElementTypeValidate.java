 ...
 */
public class ElementTypeValidate extends DescComponentValidate {

    private static String ERROR_TYPE = "Element type error";
    
    public ElementTypeValidate(TreeMap<Integer, ModelMappingTable> modelList) {
	super(modelList);
    }
	...
	if (map == null)
	    return false;
	if (map.getElementType(ref.getId()) == null)
	    return false;
	return true;
    }
}
