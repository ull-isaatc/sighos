...
public class SimultaneousFlow extends Flow {
	 ...
	 * method for the singleOrPackageOrSequence property.
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ExitFlow }
	 * {@link PackageFlow } {@link DecisionFlow } {@link SingleFlow }
	 * {@link SimultaneousFlow } {@link SequenceFlow } {@link TypeFlow }
	 */
