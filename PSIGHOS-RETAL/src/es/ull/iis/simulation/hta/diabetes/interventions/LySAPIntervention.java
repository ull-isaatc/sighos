 ...
 *
 */
public class LySAPIntervention extends SecondOrderDiabetesIntervention {
	...
	private static final double DU_SAP = -0.038;
	 ...
	 */
	public LySAPIntervention(double yearsOfEffect) {
		super(NAME, NAME);
	 ...
	 */
	public LySAPIntervention() {
		this(BasicConfigParams.DEF_MAX_AGE);
	}

	@Override
	public void addSecondOrderParams(SecondOrderParamsRepository secParams) {
		secParams.addCostParam(new SecondOrderCostParam(SecondOrderParamsRepository.STR_COST_PREFIX +LySAPIntervention.NAME, "Annual cost of SAP",  
	...
	public class Instance extends DiabetesIntervention {
		...
		public Instance(int id, SecondOrderParamsRepository secParams) {
			...
			final double auxCost = secParams.getCostParam(SecondOrderParamsRepository.STR_COST_PREFIX + LySAPIntervention.NAME);
