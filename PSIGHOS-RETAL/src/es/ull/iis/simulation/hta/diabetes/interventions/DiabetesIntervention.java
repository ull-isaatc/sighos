 ...
 *
 */
public abstract class DiabetesIntervention implements Intervention {
	 ...
	 */
	public DiabetesIntervention(final int id, final String shortName, final String description, final double yearsOfEffect) {
