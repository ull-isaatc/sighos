 ...
 *
 */
public class BattelinoSevereHypoglycemiaEvent extends SecondOrderAcuteComplicationSubmodel {
	...
	public ComplicationSubmodel getInstance(SecondOrderParamsRepository secParams) {
		return new BattelinoSevereHypoglycemiaEventInstance(secParams);
	}
	
	public class BattelinoSevereHypoglycemiaEventInstance extends AcuteComplicationSubmodel {
		 ...
		 * 
		 */
		public BattelinoSevereHypoglycemiaEventInstance(SecondOrderParamsRepository secParams) {
