...
//		pInitRet = RandomVariateFactory.getInstance("DirichletVariate", P_INIT_RET);
	...
	public static void main(String[] args) {
		final SecondOrderParamsRepository secParams = new T2DMInnerValidation(BasicConfigParams.DEF_N_PATIENTS, new WESDRPopulation());
...
//				STR_SOURCE_KLEIN, 87.0 / 634.0));
		...
		final DiabetesSimulation simul = new DiabetesSimulation(0, secParams.getInterventions()[0], BasicConfigParams.DEF_N_PATIENTS, common, secParams.getPopulation(), timeHorizon);
		final ExperimentListener<?> listener = new IncidenceView(1, secParams, timeHorizon, true);
