 ...
 *
 */
public class DCCTPrimaryConventionalSecondOrderParams extends SecondOrderParamsRepository {
	 ...
	 */
	public DCCTPrimaryConventionalSecondOrderParams(int nPatients) {
		super(nPatients, new DCCTPrimaryConventionalPopulation());
