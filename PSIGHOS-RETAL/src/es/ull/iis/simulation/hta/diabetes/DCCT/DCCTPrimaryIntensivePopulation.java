 ...
 *
 */
public class DCCTPrimaryIntensivePopulation extends DiabetesStdPopulation {
	...
	private static final double BASELINE_HBA1C_SD = 1.6; // SD from conventional therapy (the highest): https://www.nejm.org/doi/10.1056/NEJM199309303291401
	...
	private static final double P_MAN = 0.49; // DCCT: https://www.nejm.org/doi/10.1056/NEJM199309303291401

	/**
	 * @param secParams
	 * @param type
	 */
	public DCCTPrimaryIntensivePopulation() {
