...
// TODO ELLO ESTA DEFINIDO EN PAPEL MEDIANTE UN ESQUEMA
		...
		reqCamion.newWorkGroupAdder(wgParkingA).add();
		...
		reqGrua.newWorkGroupAdder(wgGrua).add();
		...
		reqTramoPatio1.newWorkGroupAdder(wgTramoA1).add();
		...
		reqTramoCentro1.newWorkGroupAdder(wgTramoA2).add();
		...
		reqtramotierra1.newWorkGroupAdder(wgTramoA3).add();
		...
		reqtramocentro2.newWorkGroupAdder(wgTramoA4).add();
		...
		reqtramopatio1vuelta.newWorkGroupAdder(wgVacio).add();
