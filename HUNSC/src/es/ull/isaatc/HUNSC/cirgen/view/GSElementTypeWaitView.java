...
/**
 * Recolecta y muestra en una hoja de Excel la información referente a la espera de los pacientes hasta que
 * son atendidos.
...
public class GSElementTypeWaitView extends View implements GSView {
	...
	/**
	 * Guardar los tiempos de espera antes de realizar la primera intervención de cada paciente. 
	 * @author Iván Castilla Rodríguez
	 */
	public class FirstWaitTime {
		...
		/**
		 * Actualiza el tiempo de espera del paciente la primera vez que se invoca. Esto sólo ocurre si el tiempo
		 ...
		 * intervención. Estos pacientes tienen tiempo de espera negativo. 
		 * @param endTs
		 */
		...
		/**
		 * Devuelve el número de pacientes que se han almacenado
		 * @return El número de pacientes que se han almacenado
		 */
		public int size() {
			return value.size();
		}
