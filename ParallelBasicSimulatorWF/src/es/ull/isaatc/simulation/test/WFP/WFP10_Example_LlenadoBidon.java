...
class SimulationWFP10E extends Simulation {
	int ndays;
	
	public SimulationWFP10E(int id, int ndays) {
		super(id, "WFP10: Arbitrary Cycle. Ej", SimulationTimeUnit.MINUTE, SimulationTime.getZero(), new SimulationTime(SimulationTimeUnit.DAY, ndays));
		this.ndays = ndays;
    }
    ...
    protected void createModel() {
        ...
        ((TimeDrivenActivity)getActivity(0)).addWorkGroup(new SimulationTimeFunction(this, "NormalVariate", 15.0, 2.0), wg1);
        ((TimeDrivenActivity)getActivity(1)).addWorkGroup(new SimulationTimeFunction(this, "NormalVariate", 15.0, 2.0), wg1);
