 ...
 * A {@link FinalizerFlow} includes a user-defined method {@link #afterFinalize(FlowExecutor)}, which is invoked 
...
public interface FinalizerFlow extends Flow {
	 ...
	 * @param FlowExecutor {@link FlowExecutor} requesting this flow
	 */
