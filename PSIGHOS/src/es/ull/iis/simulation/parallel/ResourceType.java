 ...
 */
public class ResourceType extends TimeStampedSimulationObject implements es.ull.iis.simulation.model.engine.ResourceTypeEngine {
	...
	@Override
	public es.ull.iis.simulation.model.engine.ResourceEngine[] addGenericResources(int n) {
