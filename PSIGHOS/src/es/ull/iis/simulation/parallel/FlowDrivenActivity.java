 ...
 * on the finalization of an internal {@link es.ull.iis.simulation.core.flow.Flow Flow}.
 * <p>
 ...
 *
 */
public class FlowDrivenActivity extends Activity implements es.ull.iis.simulation.core.FlowDrivenActivity {
	/** 
	...
	public class ActivityWorkGroup extends Activity.ActivityWorkGroup implements FlowDrivenActivityWorkGroup {
		...
		protected ActivityWorkGroup(int id, es.ull.iis.simulation.core.flow.InitializerFlow initFlow, 
