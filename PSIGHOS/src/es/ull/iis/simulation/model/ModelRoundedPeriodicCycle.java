 ...
 *
 */
public class ModelRoundedPeriodicCycle implements ModelCycle {
	 ...
	 */
	public ModelRoundedPeriodicCycle(TimeUnit unit, long startTs, TimeFunction period, long endTs, Type type, long scale, long shift) {
	 ...
	 * @param scale The factor to which the results are fitted. 
	 */
	public ModelRoundedPeriodicCycle(TimeUnit unit, TimeStamp startTs, TimeFunction period, TimeStamp endTs, Type type, TimeStamp scale, TimeStamp shift) {
	 ...
	 * @param scale The factor to which the results are fitted. 
	 */
	public ModelRoundedPeriodicCycle(TimeUnit unit, long startTs, TimeFunction period, int iterations, Type type, long scale, long shift) {
	 ...
	 * @param scale The factor to which the results are fitted. 
	 */
	public ModelRoundedPeriodicCycle(TimeUnit unit, TimeStamp startTs, TimeFunction period, int iterations, Type type, TimeStamp scale, TimeStamp shift) {
