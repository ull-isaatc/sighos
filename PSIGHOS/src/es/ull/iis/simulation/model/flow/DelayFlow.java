		...
		if (!wThread.wasVisited(this)) {
			if (wThread.isExecutable()) {
				if (beforeRequest(wThread)) {
					simul.notifyInfo(new ElementActionInfo(simul, wThread, wThread.getElement(), this, wThread.getExecutionWG(), ElementActionInfo.Type.START, simul.getTs()));
...
//					timeLeft = 0;
	...
	public void finish(ElementInstance wThread) {
		simul.notifyInfo(new ElementActionInfo(simul, wThread, wThread.getElement(), this, wThread.getExecutionWG(), ElementActionInfo.Type.END, simul.getTs()));
