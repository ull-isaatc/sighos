 ...
 *
 */
public class ResourceEngine extends EngineObject implements EventSourceEngine {
     ...
     */
	public ResourceEngine(SimulationEngine simul, es.ull.iis.simulation.model.Resource modelRes) {
