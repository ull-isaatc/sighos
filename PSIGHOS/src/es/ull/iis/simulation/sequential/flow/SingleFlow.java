 ...
 */
public abstract class SingleFlow extends SingleSuccessorFlow implements TaskFlow, es.ull.iis.simulation.core.flow.SingleFlow, es.ull.iis.simulation.core.BasicStep<ActivityWorkGroup, WorkThread, Resource> {
     ...
     */
	public SingleFlow(Simulation simul, String description) {
     ...
     */
    public SingleFlow(Simulation simul, String description, int priority) {
        super(simul);
	 ...
	 */
	public ArrayList<CancelListEntry> getCancellationList() {
