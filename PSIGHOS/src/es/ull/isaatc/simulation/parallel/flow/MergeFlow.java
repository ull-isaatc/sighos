...
import es.ull.isaatc.simulation.parallel.Element;
 ...
 * @author ycallero
 */
public abstract class MergeFlow extends SingleSuccessorFlow implements JoinFlow, es.ull.isaatc.simulation.core.flow.MergeFlow {
