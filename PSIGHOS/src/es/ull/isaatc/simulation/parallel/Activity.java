...
public abstract class Activity extends TimeStampedSimulationObject implements es.ull.isaatc.simulation.core.Activity {
     ...
     */
    public int addWorkGroup(int priority, es.ull.isaatc.simulation.parallel.WorkGroup wg) {
     ...
     * @return The identifier of the new WG.
     */
    public int addWorkGroup(int priority, es.ull.isaatc.simulation.parallel.WorkGroup wg, Condition cond) {
    	final int wgId = workGroupTable.size();
     ...
     * @return The identifier of the new WG.
     */
    public int addWorkGroup(es.ull.isaatc.simulation.parallel.WorkGroup wg) {    	
     ...
     * @return The identifier of the new WG.
     */
    public int addWorkGroup(es.ull.isaatc.simulation.parallel.WorkGroup wg, Condition cond) {    	
	 ...
	 */
	public class ActivityWorkGroup extends es.ull.isaatc.simulation.parallel.WorkGroup implements es.ull.isaatc.simulation.core.ActivityWorkGroup, Comparable<ActivityWorkGroup> {
	     ...
	     */    
	    protected ActivityWorkGroup(int id, int priority, es.ull.isaatc.simulation.parallel.WorkGroup wg) {
	     ...
	     * @param cond Availability condition
	     */    
	    protected ActivityWorkGroup(int id, int priority, es.ull.isaatc.simulation.parallel.WorkGroup wg, Condition cond) {
