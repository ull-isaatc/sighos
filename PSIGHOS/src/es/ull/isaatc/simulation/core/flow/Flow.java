...
import es.ull.isaatc.simulation.core.SimulationObject;
...
public interface Flow extends SimulationObject {
	 ...
	 */
	void setRecursiveStructureLink(StructuredFlow parent, Set<es.ull.isaatc.simulation.core.flow.Flow> visited);
