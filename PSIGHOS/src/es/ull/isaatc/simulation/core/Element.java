 ...
 * an associated {@link es.ull.isaatc.simulation.core.flow.Flow Flow}.
...
public interface Element extends VariableStoreSimulationObject {
	...
	ElementType getType();
	/**
	 * Returns the associated {@link es.ull.isaatc.simulation.core.flow.Flow Flow}.
	 * @return the associated {@link es.ull.isaatc.simulation.core.flow.Flow Flow}
	 */
