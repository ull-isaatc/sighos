...
public enum UserMethod {
	...
	BEFORE_REQUEST("beforeRequest", Flow.class, "public boolean beforeRequest(es.ull.isaatc.simulation.core.Element e)", Element.class),
	AFTER_FINALIZE("afterFinalize", TaskFlow.class, "public void afterFinalize(es.ull.isaatc.simulation.core.Element e)", Element.class),
	AFTER_START("afterStart", SingleFlow.class, "public void afterStart(es.ull.isaatc.simulation.core.Element e)", Element.class),
	IN_QUEUE("inqueue", SingleFlow.class, "public void inqueue(es.ull.isaatc.simulation.core.Element e)", Element.class);
