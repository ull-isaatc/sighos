...
public class PackageFlowAction extends SighosPaletteAction implements
...

	{
		...
		putValue(Action.SMALL_ICON, getPaletteIconByName("PackageCell"));
		setIdentifier(Palette.PACKAGE_NODE);
	}
