...
public class TypeJoinVertexView extends DiamondVertexView {

	private static final long serialVersionUID = 1L;

	public static transient TypeRenderer renderer = new TypeRenderer();

	public TypeJoinVertexView() {
		super();
	}

	public TypeJoinVertexView(Object cell) {
		super(cell);
	}
	...
	public static class TypeRenderer extends DoubleDiamondVertexView.DoubleDiamondRenderer {
