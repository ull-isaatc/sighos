...
public class TestHash {
	...
	public static void main(String[] args) {
		...
		Pair1 p1 = new Pair1(Integer.valueOf(1), Float.valueOf(2.0f));
		Pair1 p2 = new Pair1(Integer.valueOf(1), Float.valueOf(3.0f));
		Pair1 p1a = new Pair1(Integer.valueOf(1), Float.valueOf(2.0f));
		Pair1 p3 = new Pair1(Integer.valueOf(2), Float.valueOf(2.0f));
