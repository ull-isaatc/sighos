...
public class TimeFunctionFactory {
     ...
     * Then searches the "search packages." The search path defaults to "es.ull.isaatc.function"
    ...
    public static Class<?> findFullyQualifiedNameFor(String className) {
        ...
        for (String searchPackage : searchPackages) {
            ...
            try {
                ...
                if (!es.ull.isaatc.function.TimeFunction.class.isAssignableFrom(theClass)) {
                    continue;
                }
