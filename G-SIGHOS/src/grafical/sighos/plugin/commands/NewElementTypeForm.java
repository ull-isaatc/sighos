...
public class NewElementTypeForm extends TitleAreaDialog {
...
public NewElementTypeForm(Shell parentShell) {
super(parentShell);
}
@Override
public void create() {
...
// Set the message
setMessage("Nuevo Tipo de Elemento", IMessageProvider.INFORMATION);
}
@Override
...
label1.setText("Nombre del Tipo");
	...
	Integer ttNumber = new Integer( ET_property.et_List.size() );
	...
	varNameText.setText("et_"+ttNumber.toString());
	...
	setErrorMessage("Nombre de 'Tipo de Elemento' no valido");
	valid = false;
	}
	else {
	//   boolean repetido = false;
       ...
       int i =0;
	   while ( i < ET_property.et_List.size() ) {
	   
	      if ( ET_property.et_List.get(i).getName().equalsIgnoreCase(nameText.getText())  ) {
	    	  valid = false;
	          setErrorMessage("Nombre de 'Tipo de Elemento' Repetido");
	      }
		  i++;
	   }
	}
