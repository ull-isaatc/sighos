...
public class G_property extends Model implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public static ArrayList<G_property> g_List = new ArrayList<G_property>();
	
	private String rt_code;	
	
	protected static int cursor = 0;
	
	public G_property(String name, String varName, Integer obj_Number, String rt_cod) {
	...
	public void accept(IModelVisitor visitor, Object passAlongArgument) {
		visitor.visitG_property(this, passAlongArgument);
	}
