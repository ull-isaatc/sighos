...
//	    u.setSchema(schemaFactory.newSchema(new File("E:/isaatc/workspace/XMLGHOS/model.xsd")));
	...
	try {
	    ...
	    SchemaFactory schemaFactory = SchemaFactory
		    .newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
//	    u.setSchema(schemaFactory.newSchema(new File("E:/isaatc/workspace/XMLGHOS/experiment.xsd")));
