...
public enum StandardParameter implements ParameterTemplate {
	...
	DISEASE_PROGRESSION_DURATION(Population.DEF_MAX_AGE - Population.DEF_MIN_AGE, "Duration of the disease progression (in years)", ParameterType.OTHER, "DUR_"),
	DISEASE_PROGRESSION_END_AGE(Population.DEF_MAX_AGE, "Age at which the disease progression ends", ParameterType.OTHER, "END_AGE_"),
	...
	DISEASE_PROGRESSION_ONSET_AGE(0.0, "Age at which the disease progression starts", ParameterType.OTHER, "ONSET_AGE_"),
	...
	INCREASED_MORTALITY_RATE(1.0, "Increased mortality rate", ParameterType.OTHER, "IMR_"),
	LIFE_EXPECTANCY_REDUCTION(0.0, "Life expectancy reduction", ParameterType.OTHER, "LER_"),
