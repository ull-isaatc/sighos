 ...
 *
 */
public enum RiskParamDescriptions implements DescribesParameter {
	 ...
	 * 
	 */
	private RiskParamDescriptions(String shortPrefix, String longPrefix, double defaultValue) {
