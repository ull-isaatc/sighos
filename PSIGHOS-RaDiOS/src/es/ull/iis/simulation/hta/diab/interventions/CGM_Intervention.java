...
public class CGM_Intervention extends Intervention {
	...
	public double getAnnualCost(Patient pat) {
		return (secParams.getCostParam(STR_C_STRIPS, pat.getSimulation()) * secParams.getOtherParam(STR_USE_STRIPS, 0.0, pat.getSimulation()) +
				C_SENSOR_G5 * secParams.getOtherParam(STR_USE_SENSOR_G5, 0.0, pat.getSimulation())) * 365;
	}
