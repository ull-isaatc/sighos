...
public class MacularEdema extends DiseaseProgression {
	 ...
	 * @param disease
	 */
	public MacularEdema(HTAModel model, Disease disease) {
		super(model, NAME, "Macular Edema", disease, Type.CHRONIC_MANIFESTATION);
	}

	@Override
	public void createParameters() {
		addUsedParameter(StandardParameter.ANNUAL_COST, "", "Original analysis", COSTYEAR, COST, StandardParameter.getRandomVariateForCost(COST));
