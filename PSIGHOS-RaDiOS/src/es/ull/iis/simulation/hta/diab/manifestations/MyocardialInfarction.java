...
public class MyocardialInfarction extends ChronicManifestation {
	...
	public void registerSecondOrderParameters() {
		...
		DefaultProbabilitySecondOrderParam.PROBABILITY_DEATH.addParameter(secParams, this, this, "Core Model", P_DEATH, SecondOrderParamsRepository.getRandomVariateForProbability(P_DEATH));
