 ...
 *
 */
public class DCCT_PrimaryConventionalPopulation extends FirstOrderOnlyPopulation {
	...
	private static final double P_WOMAN = 0.46; // DCCT: https://www.nejm.org/doi/10.1056/NEJM199309303291401
	private static final double []P_INI_NEU_BETA = {8, 378 - 8}; // DCCT: https://www.nejm.org/doi/10.1056/NEJM199309303291401

	/**
	 * @param model
	 * @param disease
	 */
	public DCCT_PrimaryConventionalPopulation(HTAModel model, Disease disease) throws MalformedSimulationModelException {
