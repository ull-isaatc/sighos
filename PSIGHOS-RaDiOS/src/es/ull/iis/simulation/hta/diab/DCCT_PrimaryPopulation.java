 ...
 *
 */
public class DCCT_PrimaryPopulation extends FirstOrderOnlyPopulation {
	 ...
	 * @param disease
	 */
	public DCCT_PrimaryPopulation(HTAModel model, Disease disease) throws MalformedSimulationModelException {
