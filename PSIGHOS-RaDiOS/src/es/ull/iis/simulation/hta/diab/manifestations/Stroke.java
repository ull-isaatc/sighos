...
public class Stroke extends DiseaseProgression {
	...
	public void registerSecondOrderParameters(SecondOrderParamsRepository secParams) {
		...
		RiskParamDescriptions.PROBABILITY_DEATH.addParameter(secParams, this, "Core Model", P_DEATH, SecondOrderParamsRepository.getRandomVariateForProbability(P_DEATH));
