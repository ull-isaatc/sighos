...
public class SMBG_Intervention extends Intervention {
	...
	public void createParameters() {
		...
		StandardParameter.RESOURCE_USAGE.addParameter(model, STR_USE_STRIPS, "Use of strips in " + getDescription(), 
		...
		StandardParameter.ANNUAL_COST.addParameter(model, STR_C_STRIPS, "cost of strips", "Average from Spanish regions", 
	...
	public double getCostWithinPeriod(Patient pat, double initT, double endT, Discount discountRate) {
		...
		return discountRate.applyDiscount(
			...
			model.getParameterValue(StandardParameter.RESOURCE_USAGE.createName(STR_USE_STRIPS), pat) * 365, 
			initT, endT);
	}
