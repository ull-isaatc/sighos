...
public class CostMatrixElement {
	...
	public CostMatrixElement clone() {
		...
		obj.setFloorLimitRange(this.getFloorLimitRange() != null ? Double.valueOf(this.getFloorLimitRange()) : null);
		obj.setCeilLimitRange(this.getCeilLimitRange() != null ? Double.valueOf(this.getCeilLimitRange()) : null);
		obj.setFrequency(this.getFrequency() != null ? Double.valueOf(this.getFrequency()) : null);
		...
		obj.setCost(this.getCost() != null ? Double.valueOf(this.getCost()) : null);
		obj.setTimesCostsEvents(new ArrayList<>(this.getTimesCostsEvents()));
		obj.setYear(Integer.valueOf(this.getYear()));
