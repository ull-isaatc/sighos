 ...
 *
 */
public final class StdSurgicalServiceParameters1 extends ModelParameterMap {

	public StdSurgicalServiceParameters1() {
		...
		put(StdSurgicalSubModel.Parameters.LENGTH_OP1, HospitalModelConfig.getScaledSimulationTimeFunction(unit, 
		...
		put(StdSurgicalSubModel.Parameters.LENGTH_OP2, HospitalModelConfig.getScaledSimulationTimeFunction(unit, 
				"ConstantVariate", new TimeStamp(TimeUnit.MINUTE, 5))); 
		put(StdSurgicalSubModel.Parameters.PROB_ADM, 0.5);
		put(StdSurgicalSubModel.Parameters.LENGTH_SUR, HospitalModelConfig.getScaledSimulationTimeFunction(unit, 
				"ConstantVariate", new TimeStamp(TimeUnit.MINUTE, 90)));
		put(StdSurgicalSubModel.Parameters.LENGTH_SSUR, HospitalModelConfig.getScaledSimulationTimeFunction(unit, 
				"ConstantVariate", new TimeStamp(TimeUnit.MINUTE, 30)));
		put(StdSurgicalSubModel.Parameters.LENGTH_ASUR, HospitalModelConfig.getScaledSimulationTimeFunction(unit, 
				"ConstantVariate", new TimeStamp(TimeUnit.MINUTE, 20)));
		put(StdSurgicalSubModel.Parameters.LENGTH_POP, HospitalModelConfig.getScaledSimulationTimeFunction(unit, 
		...
		put(StdSurgicalSubModel.Parameters.NPATIENTS, TimeFunctionFactory.getInstance("ConstantVariate", 40));
		put(StdSurgicalSubModel.Parameters.NSPATIENTS, TimeFunctionFactory.getInstance("ConstantVariate", 10));
		put(StdSurgicalSubModel.Parameters.NAPATIENTS, TimeFunctionFactory.getInstance("ConstantVariate", 10));
