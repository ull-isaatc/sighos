 ...
 *
 */
public final class StdSurgicalServiceParameters2 extends ModelParameterMap {

	public StdSurgicalServiceParameters2() {
		super(StdSurgicalSubModel.Parameters.values().length);
		
		final TimeUnit unit = HospitalModelConfig.UNIT;

		put(StdSurgicalSubModel.Parameters.NBEDS, 15);
