...
public class TimeDrivenActivity extends Activity {
     ...
     */
    public int addWorkGroup(SimulationTimeFunction duration, int priority, es.ull.isaatc.simulation.sequential.WorkGroup wg) {
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(SimulationTimeFunction duration, int priority, es.ull.isaatc.simulation.sequential.WorkGroup wg, Condition cond) {
    	int wgId = workGroupTable.size();
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(SimulationTimeFunction duration, es.ull.isaatc.simulation.sequential.WorkGroup wg) {    	
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(SimulationTimeFunction duration, es.ull.isaatc.simulation.sequential.WorkGroup wg, Condition cond) {    	
    ...
    protected ArrayDeque<Resource> isFeasible(WorkItem wi) {
    	ArrayDeque<Resource> solution = super.isFeasible(wi);
    	if (solution != null) {
            if (!isNonPresential())
	...
	public void carryOut(WorkItem wItem, ArrayDeque<Resource> solution) {
		...
		double auxTs = wItem.catchResources(solution);
...
//		}
	...
	public class ActivityWorkGroup extends Activity.ActivityWorkGroup {
	     ...
	     */    
	    protected ActivityWorkGroup(int id, SimulationTimeFunction duration, int priority, es.ull.isaatc.simulation.sequential.WorkGroup wg) {
	     ...
	     * @param cond  Availability condition
	     */    
	    protected ActivityWorkGroup(int id, SimulationTimeFunction duration, int priority, es.ull.isaatc.simulation.sequential.WorkGroup wg, Condition cond) {
