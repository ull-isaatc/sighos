...
public abstract class CheckElementActionsView extends WFPTestView {
	...
	public CheckElementActionsView(WFPTestSimulation simul, String description) {
		this(simul, description, true);
	}

	public CheckElementActionsView(WFPTestSimulation simul, String description, boolean detailed) {
