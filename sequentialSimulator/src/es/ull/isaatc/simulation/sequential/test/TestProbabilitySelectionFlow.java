...
import es.ull.isaatc.simulation.sequential.flow.ProbabilitySelectionFlow;
...
class SimulationProbSel extends StandAloneLPSimulation {
	...
	public SimulationProbSel(int id, int ndays) {
		super(id, "EjProbabilidades", SimulationTimeUnit.MINUTE, SimulationTime.getZero(), new SimulationTime(SimulationTimeUnit.DAY, ndays));
		this.ndays = ndays;
    }
