...
public class WorkGroup {
	...
	class ResourceTypeTableEntry {
	     ...
	     */
		ResourceTypeTableEntry(es.ull.isaatc.simulation.sequential.ResourceType rt, int uN) {
			rType = rt;
			needed = uN;
		}
	     ...
	     */
	    public es.ull.isaatc.simulation.sequential.ResourceType getResourceType() {
	        return rType;
	    }
