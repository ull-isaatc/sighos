...
public abstract class StandardAMSimulation extends Simulation {
	 ...
	 */
	public StandardAMSimulation(int id, String description, SimulationTimeUnit unit) {
	 ...
	 */
	public StandardAMSimulation(int id, String description, SimulationTimeUnit unit, SimulationTime startTs, SimulationTime endTs) {
	 ...
	 */
	public StandardAMSimulation(int id, String description, SimulationTimeUnit unit, double startTs, double endTs) {
		super(id, description, unit, startTs, endTs);
	}
	...
	class SimulationGraph extends TreeMap<Integer, TreeSet<Integer>> {
		...
		SimulationGraph() {
			...
			// Goes through the activity list to built the adjacent list 
			for (Activity a : activityList.values()) {
				Iterator<Activity.ActivityWorkGroup> iter = a.iterator();
