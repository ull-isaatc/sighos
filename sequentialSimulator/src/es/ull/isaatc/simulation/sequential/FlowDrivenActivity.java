...
public class FlowDrivenActivity extends Activity {
     ...
     */
    public int addWorkGroup(InitializerFlow initialFlow, FinalizerFlow finalFlow, int priority, es.ull.isaatc.simulation.sequential.WorkGroup wg) {
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(InitializerFlow initialFlow, FinalizerFlow finalFlow, int priority, es.ull.isaatc.simulation.sequential.WorkGroup wg, Condition cond) {
    	int wgId = workGroupTable.size();
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(InitializerFlow initialFlow, FinalizerFlow finalFlow, es.ull.isaatc.simulation.sequential.WorkGroup wg) {    	
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(InitializerFlow initialFlow, FinalizerFlow finalFlow, es.ull.isaatc.simulation.sequential.WorkGroup wg, Condition cond) {    	
	...
	public class ActivityWorkGroup extends Activity.ActivityWorkGroup {
	     ...
	     */    
	    protected ActivityWorkGroup(int id, InitializerFlow initialFlow, FinalizerFlow finalFlow, int priority, es.ull.isaatc.simulation.sequential.WorkGroup wg) {
	     ...
	     * @param cond  Availability condition
	     */    
	    protected ActivityWorkGroup(int id, InitializerFlow initialFlow, FinalizerFlow finalFlow, int priority, es.ull.isaatc.simulation.sequential.WorkGroup wg, Condition cond) {
