...
//	final static int NELEM[] = {1, 0, 0};
	...
	protected void createModel() {
		...
		new Activity(0, this, "AcceptanceN").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 8.33), wgs[0]);
		new Activity(7, this, "AcceptanceRE").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 1), wgs[0]);

		wgs[1] = new WorkGroup(1, this, "");
		wgs[1].add(getResourceType(1), 1);
		wgs[1].add(getResourceType(8), 1);
		new Activity(1, this, "Credit checkN").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 8.13), wgs[1]);
		new Activity(8, this, "Credit checkRE").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 1), wgs[1]);

		wgs[2] = new WorkGroup(2, this, "");
		wgs[2].add(getResourceType(2), 1);
		wgs[2].add(getResourceType(8), 1);
		wgs[2].add(getResourceType(10), 1);
		new Activity(2, this, "Recomputation").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 2), wgs[2]);

		wgs[3] = new WorkGroup(3, this, "");
		wgs[3].add(getResourceType(3), 1);
		wgs[3].add(getResourceType(7), 1);
		wgs[3].add(getResourceType(9), 1);
		new Activity(3, this, "Update databaseN").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 5.56), wgs[3]);
		new Activity(9, this, "Update databaseR").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 4), wgs[3]);
		new Activity(10, this, "Update databaseE").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 10.53), wgs[3]);

		wgs[4] = new WorkGroup(4, this, "");
		wgs[4].add(getResourceType(4), 1);
		wgs[4].add(getResourceType(8), 2);
		new Activity(4, this, "Update dossierN").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 6.67), wgs[4]);
		new Activity(11, this, "Update dossierRE").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 1), wgs[4]);
		
		wgs[5] = new WorkGroup(5, this, "");
		wgs[5].add(getResourceType(5), 1);
		wgs[5].add(getResourceType(8), 1);
		wgs[5].add(getResourceType(9), 1);
		new Activity(5, this, "Compute balanceN").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 2.63), wgs[5]);
		new Activity(12, this, "Compute balanceRE").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 1), wgs[5]);
		...
		new Activity(6, this, "Produce reportNR").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 1), wgs[6]);
		new Activity(13, this, "Produce reportE").addWorkGroup(getTimeFunctionInstance("ConstantVariate", 2.63), wgs[6]);
		...
		// Resources
		SimulationCycle c1 = new SimulationPeriodicCycle(this, new SimulationTime(SimulationTimeUnit.MINUTE, 510.0), getTimeFunctionInstance("ConstantVariate", 1440.0), 0);
		int count = 0;
		...
		c[0] = new SimulationPeriodicCycle(this, new SimulationTime(SimulationTimeUnit.MINUTE, 750.0), getTimeFunctionInstance("ConstantVariate", 1440.0), 0);
		c[1] = new SimulationPeriodicCycle(this, new SimulationTime(SimulationTimeUnit.MINUTE, 510.0), getTimeFunctionInstance("ConstantVariate", 1440.0), 0);
		c[2] = new SimulationPeriodicCycle(this, new SimulationTime(SimulationTimeUnit.MINUTE, 510.0), getTimeFunctionInstance("ConstantVariate", 1440.0), 0);
		for (int i = 0; i < NELEM.length; i++)
