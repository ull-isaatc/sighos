...
import es.ull.isaatc.simulation.DecisionMetaFlow;
import es.ull.isaatc.simulation.ElementCreator;
import es.ull.isaatc.simulation.ElementType;
import es.ull.isaatc.simulation.OptionMetaFlow;
...
class Analisis extends StandAloneLPSimulation {
	...
	public Analisis(int id, int ndays) {
		super(id, "Sistema de análisis", SimulationTimeUnit.MINUTE, new SimulationTime(SimulationTimeUnit.MINUTE, 0.0), new SimulationTime(SimulationTimeUnit.DAY, ndays));
		this.ndays = ndays;
    }
