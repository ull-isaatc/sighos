...
class SimGenerators extends StandAloneLPSimulation {
	...
	public SimGenerators(int id) {
		super(id, "Test de generadores", SimulationTimeUnit.MINUTE, 0.0, NDIAS * 24.0 * 60.0);
	}
...
//    	res.addTimeTableEntry(new Cycle(480, RandomVariateFactory.getInstance("ConstantVariate", 1440.0), 0), 480, crDummy);
		...
		SimulationPeriodicCycle c = new SimulationPeriodicCycle(this, 0.0, new SimulationTimeFunction(this, "ConstantVariate", 1440.0), 0);
