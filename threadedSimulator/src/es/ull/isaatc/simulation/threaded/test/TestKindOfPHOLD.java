...
class RequestingElement extends BasicElement {
	int eventIter;
	int eventProcess;
	static SimulationTime minute = new SimulationTime(SimulationTimeUnit.MINUTE, 1);
...
class KindOfPHOLDSimulation extends StandAloneLPSimulation {
	...
	public KindOfPHOLDSimulation(int id, SimulationTime endTs, int n, int nElem, int eventIter, int eventProcess) {
		super(id, "PHOLD", SimulationTimeUnit.MINUTE, SimulationTime.getZero(), endTs);
	...
	protected void createModel() {
		...
		new TimeDrivenGenerator(this, elemCreator, new SimulationPeriodicCycle(this, SimulationTime.getZero(), new SimulationTimeFunction(this, "ConstantVariate", endTs.getValue()), 0));
	}
...
//				super.start();
			...
			public Simulation getSimulation(int ind) {
				Simulation sim = new KindOfPHOLDSimulation(ind, new SimulationTime(SimulationTimeUnit.MINUTE, nIter + 1), nAct, nElem, eventIter, eventProcess);
