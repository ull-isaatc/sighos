...
public class TimeDrivenActivity extends Activity {
     ...
     */
    public int addWorkGroup(SimulationTimeFunction duration, int priority, es.ull.isaatc.simulation.threaded.WorkGroup wg) {
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(SimulationTimeFunction duration, int priority, es.ull.isaatc.simulation.threaded.WorkGroup wg, Condition cond) {
    	int wgId = workGroupTable.size();
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(SimulationTimeFunction duration, es.ull.isaatc.simulation.threaded.WorkGroup wg) {    	
     ...
     * @return The new workgroup's identifier.
     */
    public int addWorkGroup(SimulationTimeFunction duration, es.ull.isaatc.simulation.threaded.WorkGroup wg, Condition cond) {    	
...
//		}
	...
	public class ActivityWorkGroup extends Activity.ActivityWorkGroup {
	     ...
	     */    
	    protected ActivityWorkGroup(int id, SimulationTimeFunction duration, int priority, es.ull.isaatc.simulation.threaded.WorkGroup wg) {
	     ...
	     * @param cond  Availability condition
	     */    
	    protected ActivityWorkGroup(int id, SimulationTimeFunction duration, int priority, es.ull.isaatc.simulation.threaded.WorkGroup wg, Condition cond) {
