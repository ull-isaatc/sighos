 ...
 * @author  Arnold Buss
 * @version $Id: InverseGaussianVariate.java,v 1.6 2007/02/15 19:43:02 ahbuss Exp $
 */
public class InverseGaussian2Variate extends RandomVariateBase {
...
**/
    public InverseGaussian2Variate() {
        normal = new NormalVariate();
        normal.setRandomNumber(super.rng);
        normal.setMean(0.0);
        normal.setStandardDeviation(1.0);
    }
