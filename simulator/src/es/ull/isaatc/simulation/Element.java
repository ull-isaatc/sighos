...
public class Element extends BasicElement implements RecoverableState<ElementState> {
	...
	public ElementState getState() {
		...
		if (currentSF == null)
			...
			state = new ElementState(id, elementType.getIdentifier(), flow.getState(), pending, requestedFlows, currentSF.getIdentifier());
		return state;
	}
    ...
    public class AvailableElementEvent extends BasicElement.DiscreteEvent {
        ...
        public void event() {
    		...
    		Activity act = flow.getActivity();
            waitSemaphore();
            print(Output.MessageType.DEBUG, "Calling availableElement()\t" + act, 
